...
export async function upsertArchive(i: any) {
  ...
  `, [i.origin,i.type,i.externalId,i.source ?? null,i.symbols,i.publishedAt,i.title,i.summary ?? null,i.body ?? null,i.url ?? null,i.imageUrl ?? null,i.categories ?? null,i.contentHash]);
}
